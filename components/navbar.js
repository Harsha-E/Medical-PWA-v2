  ...
  getAuthenticatedMenu(hash) {
    const navItems = [
      { 
        href: '#/dashboard', 
        label: 'Dashboard', 
        icon: '<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>' 
      },
      { 
        href: '#/medications', 
        label: 'Meds', 
        icon: '<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.5 20.5l-6-6a4.5 4.5 0 1 1 6.4-6.4l6 6a4.5 4.5 0 1 1-6.4 6.4z"></path><line x1="8.5" y1="8.5" x2="15.5" y2="15.5"></line></svg>' 
      },
      { 
        href: '#/appointments', 
        label: 'Appointments', 
        icon: '<svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>' 
      },
      { 
        href: '#/peer-hub', 
        label: 'Network', 
        // 3-Node P2P Mesh Icon
