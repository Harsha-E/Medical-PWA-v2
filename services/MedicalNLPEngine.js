...
const COMMON_MEDICINES = [
  ...
  { name: 'Saridon', generic: 'Paracetamol + Propyphenazone + Caffeine', form: 'Tablet', doses: ['250mg + 150mg + 50mg'] },
  { name: 'Shelcal 500', generic: 'Calcium + Vitamin D3', form: 'Tablet', doses: ['500mg + 250 IU'] },
  { name: 'Allegra', generic: 'Fexofenadine Hydrochloride', form: 'Tablet', doses: ['120mg', '180mg'] },
  { name: 'Montek LC', generic: 'Montelukast + Levocetirizine', form: 'Tablet', doses: ['10mg + 5mg'] },
  { name: 'Augmentin 625', generic: 'Amoxicillin + Clavulanic Acid', form: 'Tablet', doses: ['500mg + 125mg'] },
  { name: 'Telma 40', generic: 'Telmisartan', form: 'Tablet', doses: ['40mg'] },
  { name: 'Azithral 500', generic: 'Azithromycin', form: 'Tablet', doses: ['500mg'] },
  { name: 'Meftal-Spas', generic: 'Mefenamic Acid + Dicyclomine', form: 'Tablet', doses: ['250mg + 10mg'] },
  { name: 'Gelusil', generic: 'Aluminium Hydroxide + Magnesium Hydroxide + Simethicone', form: 'Syrup', doses: ['10ml'] },
  { name: 'Digene', generic: 'Aluminium Hydroxide + Magnesium Hydroxide', form: 'Tablet', doses: ['300mg'] },
  { name: 'Glycomet 500', generic: 'Metformin Hydrochloride', form: 'Tablet', doses: ['500mg'] },
  { name: 'Concor 5', generic: 'Bisoprolol Fumarate', form: 'Tablet', doses: ['5mg'] },
  { name: 'Eltroxin', generic: 'Levothyroxine Sodium', form: 'Tablet', doses: ['50mcg', '100mcg'] },
  { name: 'Limcee', generic: 'Ascorbic Acid (Vitamin C)', form: 'Tablet', doses: ['500mg'] },
  { name: 'Zerodol-P', generic: 'Aceclofenac + Paracetamol', form: 'Tablet', doses: ['100mg + 325mg'] },
  { name: 'Cheston Cold', generic: 'Cetirizine + Phenylephrine + Paracetamol', form: 'Tablet', doses: ['5mg + 10mg + 325mg'] },
  { name: 'Benadryl', generic: 'Diphenhydramine + Ammonium Chloride', form: 'Syrup', doses: ['5ml'] },
  { name: 'Ascoril', generic: 'Terbutaline + Bromhexine + Guaifenesin', form: 'Syrup', doses: ['10ml'] },
  { name: 'Calpol 500', generic: 'Paracetamol', form: 'Tablet', doses: ['500mg'] },
  { name: 'Fabiflu', generic: 'Favipiravir', form: 'Tablet', doses: ['200mg', '400mg'] },
  { name: 'O2', generic: 'Ofloxacin + Ornidazole', form: 'Tablet', doses: ['200mg + 500mg'] },
  { name: 'Norflox TZ', generic: 'Norfloxacin + Tinidazole', form: 'Tablet', doses: ['400mg + 600mg'] },
  { name: 'Metrogyl 400', generic: 'Metronidazole', form: 'Tablet', doses: ['400mg'] },
  { name: 'Sporlac', generic: 'Lactobacillus Spores', form: 'Tablet', doses: ['60 million spores'] },
  { name: 'Betadine', generic: 'Povidone Iodine', form: 'Ointment', doses: ['5%'] },
  { name: 'Candid', generic: 'Clotrimazole', form: 'Ointment', doses: ['1%'] },
  { name: 'Beco-C', generic: 'Vitamin B Complex + Vitamin C', form: 'Tablet', doses: ['1 tablet'] },
  { name: 'Supradyn', generic: 'Multivitamin + Minerals', form: 'Tablet', doses: ['1 tablet'] },
  { name: 'Zincovit', generic: 'Multivitamin + Zinc', form: 'Tablet', doses: ['1 tablet'] },
  { name: 'Disprin', generic: 'Acetylsalicylic Acid', form: 'Tablet', doses: ['325mg'] },
  { name: 'Sinarest', generic: 'Paracetamol + Phenylephrine + Chlorpheniramine', form: 'Tablet', doses: ['500mg + 10mg + 2mg'] },
  { name: 'Sumo', generic: 'Nimesulide + Paracetamol', form: 'Tablet', doses: ['100mg + 325mg'] },
  { name: 'Unienzyme', generic: 'Fungal Diastase + Papain + Activated Charcoal', form: 'Tablet', doses: ['1 tablet'] },
  { name: 'Mucolite', generic: 'Ambroxol Hydrochloride', form: 'Syrup', doses: ['30mg/5ml'] },
  { name: 'Crocin Advance', generic: 'Paracetamol', form: 'Tablet', doses: ['500mg', '650mg'] }
];
