      ...
      <div class="clay-glass-panel w-full max-w-md p-6 animate-fade-in-up relative z-10 border border-[var(--color-primary)]/30 shadow-[0_0_40px_rgba(255,184,140,0.15)]">
        ...
        <form id="login-form" class="space-y-4 relative z-10 group">
          ...
          <div id="step-1" class="transition-all duration-300">
            ...
            <button type="button" id="next-btn" class="w-full py-3 rounded-xl btn-neumorphic-primary border   font-mono text-xs font-bold uppercase tracking-widest  hover:  transition-all mt-2 overflow-hidden flex items-center justify-center gap-2".replace(/s+/g, ' ').trim()>
              Next
            </button>
          </div>
          ...
          <div id="step-2" class="hidden transition-all duration-300 opacity-0 translate-x-4">
            <div class="flex items-center gap-3 mb-4">
              <button type="button" id="back-btn" class="w-10 h-10 rounded-full btn-neumorphic flex-shrink-0 flex items-center justify-center hover:-translate-x-1 transition-transform duration-300 text-text-primary">
            ...
            <button type="submit" id="submit-btn" class="relative w-full py-3 rounded-xl btn-neumorphic-primary border   font-mono text-xs font-bold uppercase tracking-widest  hover:  transition-all mt-4 overflow-hidden flex items-center justify-center gap-2".replace(/s+/g, ' ').trim()>
