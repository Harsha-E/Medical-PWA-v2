...
export default class AppointmentsView {
  async render() {
    ...
    this.container.innerHTML = `
      <main class="flex-1 overflow-y-auto md:px-12 pt-[112px] md:pt-8 md:pl-64 lg:pl-72 md:pt-8 pb-28 w-full max-w-7xl mx-auto md:grid md:grid-cols-2 md:gap-12" style="padding-left:0; padding-right:0;">
