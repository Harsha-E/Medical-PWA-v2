...
export default class OrchestratorView {
  ...
  async render() {
    ...
    this.container.innerHTML = `
      <main class="flex-1 overflow-y-auto pt-[112px] md:pt-8 md:pl-64 lg:pl-72 md:pt-8 md:pl-64 lg:pl-72 md:pt-8 space-y-6 flex flex-col no-scrollbar pb-32" style="padding-left:0; padding-right:0;">
