  ...
  async render() {
    ...
    this.container.innerHTML = `
      <div class="w-full max-w-md p-8 rounded-3xl bg-[#1a0a12]/40 backdrop-blur-3xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] animate-fade-in-up relative overflow-hidden" style="box-shadow: inset 0 2px 20px rgba(255,255,255,0.05), 0 20px 50px rgba(0,0,0,0.7);">
        <!-- Inner glow -->
        <div class="absolute -bottom-24 -left-24 w-48 h-48 bg-[#7f2f5d]/30 blur-[50px] rounded-full pointer-events-none"></div>
        <div class="absolute -top-24 -right-24 w-48 h-48 bg-[#ca5229]/20 blur-[50px] rounded-full pointer-events-none"></div>
        ...
        <div class="text-center mb-8 relative z-10">
          ...
          <h2 class="text-3xl font-display font-bold text-white tracking-tight">Initialize</h2>
          <p class="text-[#ffb88c] text-xs mt-2 font-mono uppercase tracking-widest opacity-80">Create secure ledger</p>
        </div>
        ...
        <form id="register-form" class="space-y-4 relative z-10">
          ...
          <button type="submit" id="email-btn" class="w-full py-4 rounded-xl bg-gradient-to-r from-[#7f2f5d] to-[#ca5229] border border-[#ffb88c]/30 text-white font-mono text-xs font-bold uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all shadow-[0_0_20px_rgba(202,82,41,0.3)] mt-2">
            Deploy Protocol
          </button>
        </form>
        ...
        <div class="relative flex items-center py-6 z-10">
          ...
          <span class="flex-shrink-0 mx-4 text-gray-500 text-[10px] font-mono uppercase tracking-widest">Or</span>
          <div class="flex-grow border-t border-white/10"></div>
        </div>
        ...
        <p class="mt-8 text-center text-xs text-gray-400 font-mono uppercase tracking-widest relative z-10">
          Already secured? <a href="#/login" class="text-[#ffb88c] hover:text-white transition-colors font-bold ml-1">Access Portal</a>
        </p>
      </div>
    `;
