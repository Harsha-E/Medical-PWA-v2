...
export default class RegisterView {
    ...
    this.container.innerHTML = `
      ...
      <div class="clay-glass-panel w-full max-w-md p-6 animate-fade-in-up relative z-10">
        ...
        <div class="text-center mb-8 relative z-10">
          ...
          <h2 class="text-3xl font-display font-bold tracking-tight" style="color: var(--color-text-primary);">Initialize</h2>
        ...
        <form id="register-form" class="space-y-4 relative z-10 group">
          ...
          <div id="step-2" class="hidden transition-all duration-300 opacity-0 translate-x-4">
            <div class="flex items-center gap-3 mb-4">
              <button type="button" id="back-btn-1" class="p-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-[var(--color-text-secondary)] transition-colors">
            ...
            <div class="w-full flex gap-1 h-1.5 rounded-full overflow-hidden mt-4" id="strength-meter">
                <div class="h-full flex-1 bg-white/10 transition-colors duration-300" id="s-1"></div>
                <div class="h-full flex-1 bg-white/10 transition-colors duration-300" id="s-2"></div>
                <div class="h-full flex-1 bg-white/10 transition-colors duration-300" id="s-3"></div>
            </div>

            <button type="button" id="next-btn-2" class="w-full py-3 rounded-xl bg-gradient-to-r from-[#7f2f5d] to-[#ca5229] border border-[#ffb88c]/30 text-[var(--color-text-primary)] font-mono text-xs font-bold uppercase tracking-widest hover:shadow-lg hover:shadow-[#ca5229]/20 active:scale-95 transition-all mt-6 overflow-hidden flex items-center justify-center gap-2">
              Continue
            </button>
          </div>
          ...
          <div id="step-3" class="hidden transition-all duration-300 opacity-0 translate-x-4">
            <div class="flex items-center gap-3 mb-4">
              <button type="button" id="back-btn-2" class="p-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-[var(--color-text-secondary)] transition-colors">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
              </button>
              <div class="text-xs font-mono text-[var(--color-text-secondary)] truncate flex-1" id="display-password-step">Confirm Password</div>
            </div>
            ...
            <div class="google-input-group relative">
              ...
              <button type="button" id="toggle-confirm-password" class="absolute right-4 top-1/2 -translate-y-1/2 text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] focus:outline-none z-10" style="padding: 0; background: transparent; border: none; outline: none;">
        ...
        <div id="federated-section" class="transition-all duration-300">
          ...
          <p class="mt-8 text-center text-xs font-mono uppercase tracking-widest relative z-10" style="color: var(--color-text-secondary);">
            Already have an account? <a href="#/login" class="text-[#ca5229] hover:text-[#7f2f5d] transition-colors font-bold ml-1">Login here</a>
          </p>
        </div>
      </div>
    `;
  ...
  bindEvents() {
    ...
    passwordInput.addEventListener('input', (e) => {
        ...
        s1.className = 'h-full flex-1 transition-colors duration-300 ' + (score > 0 ? (score === 1 ? 'bg-red-500' : (score === 2 ? 'bg-amber-400' : 'bg-green-500')) : 'bg-white/10');
        s2.className = 'h-full flex-1 transition-colors duration-300 ' + (score > 1 ? (score === 2 ? 'bg-amber-400' : 'bg-green-500') : 'bg-white/10');
        s3.className = 'h-full flex-1 transition-colors duration-300 ' + (score > 2 ? 'bg-green-500' : 'bg-white/10');
    });
