    ...
    this.container.innerHTML = `
      ...
      <div class="w-full max-w-md p-8 rounded-3xl bg-white/70 backdrop-blur-3xl border border-white/60 shadow-[0_20px_50px_rgba(0,0,0,0.15)] animate-fade-in-up relative overflow-hidden" style="box-shadow: inset 0 2px 20px rgba(255,255,255,0.8), 0 20px 50px rgba(0,0,0,0.1);">
        ...
        <div class="text-center mb-8 relative z-10">
          ...
          <h2 class="text-3xl font-display font-bold text-gray-900 tracking-tight">Initialize</h2>
        ...
        <form id="register-form" class="space-y-5 relative z-10 group">
          ...
          <div class="relative">
            <input type="password" id="password" autocomplete="new-password" required class="peer w-full px-5 py-4 pt-6 rounded-xl bg-white/60 border border-white/80 text-gray-900 placeholder-transparent focus:outline-none focus:ring-2 focus:ring-[#7f2f5d]/30 focus:bg-white transition-all font-sans shadow-sm" placeholder="Create Security Key">
            <label for="password" class="absolute left-5 top-2 text-[10px] font-mono uppercase tracking-widest text-gray-500 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:text-xs peer-placeholder-shown:normal-case peer-placeholder-shown:tracking-normal peer-focus:top-2 peer-focus:text-[10px] peer-focus:uppercase peer-focus:tracking-widest peer-focus:text-[#7f2f5d] pointer-events-none">Create Security Key</label>
          </div>
