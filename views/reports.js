...
export default class ReportsView {
  async render() {
    ...
    this.container.innerHTML = `
      ...
      <main class="scroll-area px-6 md:px-12 pt-28 pb-28 max-w-7xl mx-auto">
      ...
      <main class="scroll-area px-6 md:px-12 pt-28 pb-28 max-w-7xl mx-auto">
        <div class="md:grid md:grid-cols-12 md:gap-10">
          ...
          <div class="md:col-span-7 lg:col-span-8 mt-10 md:mt-0">
            ${totalExpected30 === 0 ? '' : `
              <section class="mb-8">
                <h3 class="section-title text-xs text-uppercase font-bold text-muted mb-4 tracking-[0.2em] px-1">Weekly Trend</h3>
