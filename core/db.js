...
// ─── Schema Version 13 (Clinical Links & Relationships) ───────────────
db.version(13).stores({
  ...
  medicines:       '++id, name, genericName, manufacturer',
  trusted_devices: 'installationId, deviceName, peerId, publicKey, firstSeen, lastSeen, permissions, protocolVersion',
  clinical_links:  '++id, sourceEntity, sourceId, targetEntity, targetId, relationType, userId, createdBy, updatedAt, logicalClock, isDeleted'
});

// ─── Schema Version 14 (DIC Observability / Analysis Lifecycle) ───────
db.version(14).stores({
  ...
  trusted_devices: 'installationId, deviceName, peerId, publicKey, firstSeen, lastSeen, permissions, protocolVersion',
  clinical_links:  '++id, sourceEntity, sourceId, targetEntity, targetId, relationType, userId, createdBy, updatedAt, logicalClock, isDeleted',
  clinical_analyses: '++id, trackingId, status, analysisId, severity, userId'
});
